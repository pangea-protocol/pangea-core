...
library RewardTickIndex {
    ...
    function needToInitialize(IRewardLiquidityPool pool, int24 index) private view returns (bool) {
    ...
    function atWrongPlace(
        ...
        IRewardLiquidityPool.Tick memory old = pool.ticks(indexOld);
    ...
    function atUpperNext(
        ...
        IRewardLiquidityPool.Tick memory old = pool.ticks(lowerOld);
    ...
    function findIndex(
        ...
        IRewardLiquidityPool.Tick memory targetTick = pool.ticks(targetIndex);
